...
import ProbDrive2016ITSC: CurvePt
...
baremodule ControlStatus
    const UNKNOWN             = 0x00 # OTHERS REMOVED - BOSCH PROPRIETARY
...
function calc_front_vehicle_colset(runlog::RunLog, sn::StreetNetwork, colset::UInt, frame::Int)
    ...
    dist = -(get(runlog, colset, frame, :footpoint)::CurvePt).s # [m] dist along curve from host inertial to base of footpoint
