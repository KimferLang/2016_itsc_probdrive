...
ProbDrive2016ITSC.get_targets(behavior::LinearGaussianBayesianNetBehavior) = behavior.targets
function ProbDrive2016ITSC.get_indicators(behavior::LinearGaussianBayesianNetBehavior)
...
function _process_obs(behavior::LinearGaussianBayesianNetBehavior)
    process!(behavior.clamper_cont) # NOTE - ensure that clamper_cont is tied to extractor_cont
